...
function fix_funcs_signature(funcRepo, context)
{
   return Promise.mapSeries(_.keys(funcRepo), function(file){
...
module.exports = {
   ...
   fix_funcs_signature: fix_funcs_signature
};
