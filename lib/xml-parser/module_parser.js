...
{
   let fileModel = hexo.model("ModuleModel");
      ...
      return new Promise(function(resolve, reject){
         ...
         return new Promise(function(resolve, reject){
            parser.parseString(content, function (err, fileJsonData) {
               ...
               Promise.all([
                     doxygenElementParser.parse_includes(fileJsonData, fileObject, fileModel),
                     doxygenElementParser.parse_definitions(fileJsonData, fileObject, fileModel),
                     ...
                     doxygenElementParser.parse_submodules(fileJsonData, fileObject, fileModel)
                  ]
               ).then(function(){
                  resolve();
               });
